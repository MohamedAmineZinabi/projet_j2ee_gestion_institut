  ...
  <div class="container">
    ...
    <% 
        ...
        try {
            ...
            String sql = "SELECT * FROM langues WHERE ordre = ?";
            ...
            if (rs.next()) {
                ...
                String updateSql = "UPDATE langues SET septembre=?, octobre=?, novembre=?, decembre=?, " +
     ...
     updateStatement.setString(12, code);
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="branch" value="Langues étrangères" readonly>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="langue" value="<%= langue %>" readonly>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
...
<div class="button-group">
    ...
    <script>
        ...
        function modifierInformations() {
            ...
            const url = '/Gestion_de_cours_soutien/LanguesDataServlet'; // URL de votre servlet de mise à jour
