        ...
        <table id="financeTable">
            ...
            <tbody id="tableBody">
                ...
                try {
                    ...
                    String sql = "SELECT ordre, CODE, Nom_Complet, Date_inscription, Date_debut, Prix, septembre, octobre, novembre, decembre, janvier, fevrier, mars, avril, mai, juin, juillet FROM finance ";
