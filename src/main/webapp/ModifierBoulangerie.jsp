...
<%@ page import="gestion_de_cours_soutien.ModifierBoulangerieServlet" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Modifier Boulangerie</title>
     <style>
        body {
...
<body>
    <div class="container">
        ...
        %>
                    <form action="ModifierBoulangerieServlet" method="post" onsubmit="displaySuccessMessage()">
                        ...
                        <button type="button" onclick="window.location.href='Boulangerie.jsp'">Retour</button>
                    </form>
        <%
                } else {
    ...
    <script>
        ...
        function displaySuccessMessage() {
            ...
            messageDiv.innerHTML = "boulangerie data modified successfully.";
        }
    </script>
</body>
</html>
