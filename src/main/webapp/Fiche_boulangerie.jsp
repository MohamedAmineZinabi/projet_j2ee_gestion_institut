  ...
  <div class="container">
    ...
    <% 
        ...
        try {
            ...
            String sql = "SELECT * FROM boulangerie WHERE ordre = ?";
     ...
     updateStatement.setString(12, code);
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="branch" value="Technicien spécialisé en boulangerie et patisserie" readonly>
                </div>
                 <div class="form-group">
...
<div class="button-group">
    ...
    <script>
        ...
        function modifierInformations() {
            ...
            const url = '/Gestion_de_cours_soutien/BoulangerieDataServlet'; // URL de votre servlet de mise à jour
