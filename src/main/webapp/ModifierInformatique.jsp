...
<%@ page import="gestion_de_cours_soutien.ModifierInformatiqueServlet" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Modifier Informatique</title>
     <style>
        body {
...
<body>
    <div class="container">
        ...
        %>
                    <form action="ModifierInformatiqueServlet" method="post" onsubmit="displaySuccessMessage()">
                        ...
                        <button type="button" onclick="window.location.href='Informatique.jsp'">Retour</button>
                    </form>
        <%
                } else {
    ...
    <script>
        ...
        function displaySuccessMessage() {
            ...
            messageDiv.innerHTML = "Informatique data modified successfully.";
        }
    </script>
</body>
</html>
