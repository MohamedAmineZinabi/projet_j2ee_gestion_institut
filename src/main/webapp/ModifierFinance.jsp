...
<%@ page import="gestion_de_cours_soutien.ModifierFinanceServlet" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        %>
                    <form action="ModifierFinanceServlet" method="post" onsubmit="displaySuccessMessage()">
                        ...
                        <button type="button" onclick="window.location.href='Finance.jsp'">Retour</button>
                    </form>
        <%
                } else {
    ...
    <script>
        ...
        function displaySuccessMessage() {
            ...
            messageDiv.innerHTML = "Finance data modified successfully.";
        }
    </script>
</body>
</html>
